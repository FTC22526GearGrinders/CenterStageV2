...
public class OpenCVAprilTag extends CommandBase {
    ...
    void tagToTelemetry(AprilTagDetection detection) {
        ...
        m_opMode.telemetry.addLine(String.format("Translation X: %.2f in",detection.pose.x * 39.37));
        m_opMode.telemetry.addLine(String.format("Translation Y: %.2f in", detection.pose.y * 39.37));
        m_opMode.telemetry.addLine(String.format("Translation Z: %.2f in", detection.pose.z * 39.37));
