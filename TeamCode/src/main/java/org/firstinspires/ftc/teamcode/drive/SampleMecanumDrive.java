...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public double getLeftFrontInches() {
        return encoderTicksToInches(leftFront.getCurrentPosition());
    }
    public double getLeftRearInches() {
        return encoderTicksToInches(leftRear.getCurrentPosition());
    }

    public double getRightFrontInches() {
        return encoderTicksToInches(rightFront.getCurrentPosition());
    }
    public double getRighttRearInches() {
        return encoderTicksToInches(rightRear.getCurrentPosition());
    }
